      ...
      <section id="advisor">
        ...
        <div className="political-figure">
          ...
          <div className="text-center text-slate-500 mt-5">
            <p>We provide to you the best choiches for you. The leading</p>
            <p> political campaign intelligence platform</p>
          </div>
          <div class="container mx-auto p-4 sm:p-8 mt-12">
            <div class="flex flex-col sm:flex-row justify-center lg:items-center space-y-4 sm:space-y-0 sm:space-x-4">
              <div class="w-full sm:w-72 h-60 hover:border border hover:border-blue-500 p-4 rounded-lg">
                <div class="flex items-center space-x-3">
                  ...
                  />
                  <h3 class="font-bold text-md lg:text-md">
                    Airlangga Hartanto
                  </h3>
                </div>
                <p class="text-start text-slate-700 mt-4">
              ...
              <div class="w-full sm:w-72 h-60 hover:border border hover:border-blue-500 p-4 rounded-lg">
                <div class="flex items-center space-x-3">
                  <img
                    ...
                    class="w-10 h-10 rounded-full object-cover"
                  />
                  <h3 class="font-bold text-md lg:text-md">Jokowi Dodo</h3>
                </div>
                <p class="text-start text-slate-700 mt-4">
              ...
              <div class="w-full sm:w-72 h-60 hover:border border hover:border-blue-500 p-4 rounded-lg">
                <div class="flex items-center space-x-3">
                  <img
                    ...
                    class="w-10 h-10 rounded-full object-cover"
                  />
                  <h3 class="font-bold text-md lg:text-md">Puan Maharani</h3>
                </div>
                <p class="text-start text-slate-700 mt-4">
                  Daerah merupakan bagian dari pemerintah yang langsung
